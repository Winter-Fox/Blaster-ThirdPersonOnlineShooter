...
#include "MultiplayerPlugin/Public/Menu.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMenu() {}
// Cross Module References
	MULTIPLAYERPLUGIN_API UClass* Z_Construct_UClass_UMenu_NoRegister();
	MULTIPLAYERPLUGIN_API UClass* Z_Construct_UClass_UMenu();
...
// End Cross Module References
	...
	{
		P_GET_UBOOL(Z_Param_bWasSucceful);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnStartSession(Z_Param_bWasSucceful);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMenu::execOnDestroySession)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnDestroySession(Z_Param_bWasSucceful);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMenu::execOnCreateSession)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnCreateSession(Z_Param_bWasSucceful);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_MenuSetup_Statics::Function_MetaDataParams[] = {
		...
		{ "CPP_Default_MatchType", "Deathmatch" },
	...
	void Z_Construct_UFunction_UMenu_OnCreateSession_Statics::NewProp_bWasSucceful_SetBit(void* Obj)
	{
		((Menu_eventOnCreateSession_Parms*)Obj)->bWasSucceful = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMenu_OnCreateSession_Statics::NewProp_bWasSucceful = { "bWasSucceful", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Menu_eventOnCreateSession_Parms), &Z_Construct_UFunction_UMenu_OnCreateSession_Statics::NewProp_bWasSucceful_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_OnCreateSession_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_OnCreateSession_Statics::NewProp_bWasSucceful,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_OnCreateSession_Statics::Function_MetaDataParams[] = {
		{ "Comment", "/**\n\x09 * Callbacks fot the custom delegates on the MultiplayerSessionSubsystem.\n\x09**/" },
		{ "ModuleRelativePath", "Public/Menu.h" },
		{ "ToolTip", "Callbacks fot the custom delegates on the MultiplayerSessionSubsystem." },
	};
#endif
	...
	void Z_Construct_UFunction_UMenu_OnDestroySession_Statics::NewProp_bWasSucceful_SetBit(void* Obj)
	{
		((Menu_eventOnDestroySession_Parms*)Obj)->bWasSucceful = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMenu_OnDestroySession_Statics::NewProp_bWasSucceful = { "bWasSucceful", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Menu_eventOnDestroySession_Parms), &Z_Construct_UFunction_UMenu_OnDestroySession_Statics::NewProp_bWasSucceful_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_OnDestroySession_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_OnDestroySession_Statics::NewProp_bWasSucceful,
	};
#if WITH_METADATA
	...
	void Z_Construct_UFunction_UMenu_OnStartSession_Statics::NewProp_bWasSucceful_SetBit(void* Obj)
	{
		((Menu_eventOnStartSession_Parms*)Obj)->bWasSucceful = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMenu_OnStartSession_Statics::NewProp_bWasSucceful = { "bWasSucceful", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Menu_eventOnStartSession_Parms), &Z_Construct_UFunction_UMenu_OnStartSession_Statics::NewProp_bWasSucceful_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_OnStartSession_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_OnStartSession_Statics::NewProp_bWasSucceful,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 2464912754
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 1038089479
		{ &Z_Construct_UFunction_UMenu_OnDestroySession, "OnDestroySession" }, // 3742914069
		{ &Z_Construct_UFunction_UMenu_OnStartSession, "OnStartSession" }, // 52529445
	};
#if WITH_METADATA
	...
	template<> MULTIPLAYERPLUGIN_API UClass* StaticClass<UMenu>()
	{
		return UMenu::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMenu);
	struct Z_CompiledInDeferFile_FID_Blaster_Plugins_MultiplayerPlugin_Source_MultiplayerPlugin_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Blaster_Plugins_MultiplayerPlugin_Source_MultiplayerPlugin_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 1480652315U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Blaster_Plugins_MultiplayerPlugin_Source_MultiplayerPlugin_Public_Menu_h_2247614904(TEXT("/Script/MultiplayerPlugin"),
		Z_CompiledInDeferFile_FID_Blaster_Plugins_MultiplayerPlugin_Source_MultiplayerPlugin_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Blaster_Plugins_MultiplayerPlugin_Source_MultiplayerPlugin_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
